 ...
 * MCP-tool wrappers; tests; any future T2 reader) reach the writers, the
 * mapping function, and the v1 types through this single import path so
 * the module's internal file layout is not part of the public surface.
 */
