...
4. **Runtime.** An agent imports the module's barrel. The barrel runs prerequisite checks (e.g. `docker --version`); failures throw at import. The agent uses the exported utilities.
