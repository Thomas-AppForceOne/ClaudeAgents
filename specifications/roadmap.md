...
**Effort estimate:** ~20–26 sprints of focused work (~5–7 calendar months at one full-time developer).
...
9. **[H1](H1-framework-owned-confinement-hook.md)** — framework-owned confinement hook. ~4–5 sprints. **Next.** Lands between the I-series and orchestrator-level work so confinement is correct before agent flows ship.
...
14. **[O3](O3-telemetry-semantics.md)** — telemetry semantics. ~2–3 sprints. Depends on T1; can run in parallel with W1, D1.
